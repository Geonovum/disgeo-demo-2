...
import { Workspace, DefaultToolbar } from 'ontodia';
import { ToolbarProps } from 'ontodia';

export interface DisGeoProps  extends ToolbarProps {
    onExampleClick?: () => void;
    onGenerateSparql?: (toolbar: DisGeoToolbar) => void;
    onForceLayout?: () => void;
}

const CLASS_NAME = 'ontodia-toolbar';

export class DisGeoToolbar extends React.Component<DisGeoProps, {}> {
    ...
    private onGenerateSparql = () => {
        this.props.onGenerateSparql(this);
    }
    ...
    public setWorkspace(newWs: Workspace ){

        this.state = { "workspace" : newWs}
    }
    render() {
        return (
